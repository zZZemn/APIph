    ...
    <div class="container mt-5">
        ...
        <div class="endpoints-main-container mt-5 mb-5">
            <div class="card container p-3"
                style="background-color: rgba(255, 255, 255, 0.014); color: rgba(255, 255, 255, 0.836)">
                <h6>Get Regions</h6>
                <div class="endpoint-container d-flex mt-2">
                    ...
                    <input class="form-control bg-dark text-light m-1 mt-0 mb-0" type="text" readonly
                        value="http://127.0.0.1:8000/api/regions">
                </div>
            </div>
            ...
            <div class="card container p-3 mt-4"
                ...
                <div class="endpoint-container d-flex mt-2">
                    <button class="btn btn-success">GET</button>
                    <input class="form-control bg-dark text-light m-1 mt-0 mb-0" type="text" readonly
                        value="http://127.0.0.1:8000/api/barangays">
                </div>
                <div class="endpoint-container d-flex mt-2">
                    <button class="btn btn-success">GET</button>
                    <input class="form-control bg-dark text-light m-1 mt-0 mb-0" type="text" readonly
